...
export function EmojiPickerPanel({
  ...
  const [activeTab, setActiveTab] = useState<"native" | "custom">(
    showCustomEmojis ? readStoredEmojiTab() : "native",
  );
  ...
  useEffect(() => {
    if (showCustomEmojis && activeTab === "custom" && !customEmojiLoaded) {
      void loadCustomEmojis();
    }
  }, [activeTab, customEmojiLoaded, loadCustomEmojis, showCustomEmojis]);
  ...
  return (
    <div data-emoji-picker="true" className="flex min-h-0 flex-col">
      {showCustomEmojis ? (
      ...
      {activeTab === "native" || !showCustomEmojis ? (
        ...
        <div className="flex flex-col p-3" style={{ height: pickerHeight }}>
